...
export function flip(start$, ready$, fadeIn$, options) {
  // const [startTitle$, other1$] =
  //   start$::partition(({ flipType }) => flipType === 'title');
  //
  // const [startProject$, startOther$] =
  //   other1$::partition(({ flipType }) => flipType === 'project');
