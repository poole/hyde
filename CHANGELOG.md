...
[pstate]: docs/8.0.0-alpha.21/scripts.md#registering-push-state-event-listeners
...
* Reduced building time during development.
  ...
  For more on how to improve building speeds, [see here](docs/8.0.0-alpha.21/writing.md#a-word-on-building-speeds).
...
[migration]: docs/8.0.0-alpha.21/upgrade.md
[writing]: docs/8.0.0-alpha.21/writing.md
[scripts]: docs/8.0.0-alpha.21/scripts.md
