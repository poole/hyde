...
[pstate]: docs/7.5.1/scripts.md#registering-push-state-event-listeners
...
* Reduced building time during development.
  ...
  For more on how to improve building speeds, [see here](docs/7.5.1/writing.md#a-word-on-building-speeds).
...
[migration]: docs/7.5.1/migration.md
[writing]: docs/7.5.1/writing.md
[scripts]: docs/7.5.1/scripts.md
