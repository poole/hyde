...
[pstate]: docs/7.0.0-beta.7/scripts.md#registering-push-state-event-listeners
...
* Reduced building time during development.
  ...
  For more on how to improve building speeds, [see here](docs/7.0.0-beta.7/writing.md#a-word-on-building-speeds).
...
[migration]: docs/7.0.0-beta.7/migration.md
