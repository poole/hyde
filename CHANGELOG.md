...
* Added experimental offline support via Service Workers. Use with care!
  For details, [read the docs](docs/8.0.0-beta.9/advanced.md#enabling-offline-support).
...
[pstate]: docs/8.0.0-beta.9/scripts.md#registering-push-state-event-listeners
...
* Reduced building time during development.
  ...
  For more on how to improve building speeds, [see here](docs/8.0.0-beta.9/writing.md#a-word-on-building-speeds).
...
[migration]: docs/8.0.0-beta.9/upgrade.md
[writing]: docs/8.0.0-beta.9/writing.md
[scripts]: docs/8.0.0-beta.9/scripts.md
