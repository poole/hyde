...
[pstate]: docs/8.0.0-beta.5/scripts.md#registering-push-state-event-listeners
...
* Reduced building time during development.
  ...
  For more on how to improve building speeds, [see here](docs/8.0.0-beta.5/writing.md#a-word-on-building-speeds).
...
[migration]: docs/8.0.0-beta.5/upgrade.md
