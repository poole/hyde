...
const SHELL_CACHE = "shell-8.0.0-beta.9--v{{ cv }}--sw{{ '/' | relative_url }}";
...
const SHELL_FILES = [
  ...
  "{{ '/assets/js/hydejack-8.0.0-beta.9.js' | relative_url }}",
  "{{ '/assets/css/hydejack-8.0.0-beta.9.css' | relative_url }}",
