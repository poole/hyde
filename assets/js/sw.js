...
const SHELL_CACHE = "shell-8.0.0-beta.5--v{{ cv }}--sw{{ '/' | relative_url }}";
...
const SHELL_FILES = [
  ...
  "{{ '/assets/js/hydejack-8.0.0-beta.5.js' | relative_url }}",
  "{{ '/assets/css/hydejack-8.0.0-beta.5.css' | relative_url }}",
