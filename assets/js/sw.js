...
const SHELL_CACHE = "shell-8.1.0-beta.3--v{{ cv }}--sw{{ '/' | relative_url }}";
...
const SHELL_FILES = [
  ...
  "{{ '/assets/js/hydejack-8.1.0-beta.3.js' | relative_url }}",
  "{{ '/assets/css/hydejack-8.1.0-beta.3.css' | relative_url }}",
