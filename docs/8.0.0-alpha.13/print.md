...
you can find it [here]({{ site.baseurl }}{% link docs/8.0.0-alpha.13/index.md %}).
{:.message}
...
~~~bash
$ cd ~/Downloads/hydejack-pro-8.0.0-alpha.13/install/
~~~
...
~~~bash
$ cp ~/Downloads/hydejack-pro-v8.0.0-alpha.13/.ssh/hydejack_pro_customers ~/.ssh/
~~~
