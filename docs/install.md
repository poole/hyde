...
[src]: https://github.com/qwtel/hy-starter-kit/archive/v8.5.0-beta.1.zip
...
~~~bash
$ cd ~/Downloads/hydejack-pro-8.5.0-beta.1/install/
~~~
...
~~~bash
$ cp ~/Downloads/hydejack-pro-8.5.0-beta.1/.ssh/hydejack_8_pro ~/.ssh/
~~~
