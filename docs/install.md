...
[src]: https://github.com/qwtel/hy-starter-kit/archive/v8.3.2.zip
...
~~~bash
$ cd ~/Downloads/hydejack-pro-8.3.2/install/
~~~
...
~~~bash
$ cp ~/Downloads/hydejack-pro-8.3.2/.ssh/hydejack_8_pro ~/.ssh/
~~~
