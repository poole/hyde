...
you can find it [here]({{ site.baseurl }}{% link docs/8.0.0-alpha.29/index.md %}).
{:.message}
...
~~~bash
$ cd ~/Downloads/hydejack-pro-8.0.0-alpha.29/install/
~~~
...
~~~bash
$ cp ~/Downloads/hydejack-pro-v8.0.0-alpha.29/.ssh/hydejack_pro_customers ~/.ssh/
~~~
...
author:
  social:
    ...
    download: https://github.com/qwtel/hydejack/archive/v8.0.0-alpha.29.zip
~~~
