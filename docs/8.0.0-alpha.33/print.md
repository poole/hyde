...
you can find it [here]({{ site.baseurl }}{% link docs/8.0.0-alpha.33/index.md %}).
{:.message}
...
~~~bash
$ cd ~/Downloads/hydejack-pro-8.0.0-alpha.33/install/
~~~
...
~~~bash
$ cp ~/Downloads/hydejack-pro-v8.0.0-alpha.33/.ssh/hydejack_pro_customers ~/.ssh/
~~~
