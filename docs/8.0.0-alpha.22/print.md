...
you can find it [here]({{ site.baseurl }}{% link docs/8.0.0-alpha.22/index.md %}).
{:.message}
...
~~~bash
$ cd ~/Downloads/hydejack-pro-8.0.0-alpha.22/install/
~~~
...
~~~bash
$ cp ~/Downloads/hydejack-pro-v8.0.0-alpha.22/.ssh/hydejack_pro_customers ~/.ssh/
~~~
...
author:
  social:
    ...
    download: https://github.com/qwtel/hydejack/archive/v8.0.0-alpha.22.zip
~~~
