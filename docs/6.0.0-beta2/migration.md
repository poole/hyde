...
For more information, see [Adding an author]({{ site.baseurl }}{% link docs/6.0.0-beta2/configuration.md %}#adding-an-author).
...
Continue with [Basics]({{ site.baseurl }}{% link docs/6.0.0-beta2/basics.md %}){:data-flip="title"} »
{:.faded.heading}
