...
Otherwise [download the source files](https://github.com/qwtel/hydejack-starter-kit/archive/v8.1.0-beta.0-beta.3.zip)
...
~~~bash
$ cd ~/Downloads/hydejack-pro-8.1.0-beta.0/install/
~~~
...
~~~bash
$ cp ~/Downloads/hydejack-pro-v8.1.0-beta.0/.ssh/hydejack_8_pro ~/.ssh/
~~~
