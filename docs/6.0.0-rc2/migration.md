...
For more information, see [Adding an author]({{ site.baseurl }}{% link docs/6.0.0-rc2/configuration.md %}#adding-an-author).
...
Continue with [Basics]({{ site.baseurl }}{% link docs/6.0.0-rc2/basics.md %}){:data-flip="title"} »
{:.faded.heading}
