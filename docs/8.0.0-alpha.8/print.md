...
you can find it [here]({{ site.baseurl }}{% link docs/8.0.0-alpha.8/index.md %}).
{:.message}
...
~~~bash
$ cd ~/Downloads/hydejack-pro-8.0.0-alpha.8/install/
~~~
...
~~~bash
$ cp ~/Downloads/hydejack-pro-v8.0.0-alpha.8/.ssh/hydejack_pro_customers ~/.ssh/
~~~
