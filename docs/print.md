...
[src]: https://github.com/hydecorp/hy-starter-kit/archive/v9.0.0-alpha.8.zip
...
~~~bash
$ cd ~/Downloads/hydejack-pro-9.0.0-alpha.8/install/
~~~
...
```yml
remote_theme: hydecorp/hydejack@v9.0.0-alpha.8
```
...
author:
  social:
    ...
    download: https://github.com/hydecorp/hydejack/archive/v9.0.0-alpha.8.zip
~~~
