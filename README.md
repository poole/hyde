...
* Print layout
* [Extensive documentation](https://qwtel.com/hydejack/docs/latest/)
...
You can find the full list including copyright notices [here](https://qwtel.com/hydejack/docs/latest/licenses/).

## Versions
The current version is 6.1.1, which was released on 23 May 2017.
You can find the full version history including patch notes [here](https://qwtel.com/hydejack/docs/latest/versions/).
